namespace MoneyMirror.Core.Interfaces
{
    ...
    public interface IEmailService
    {
        ...
        Task<bool> SendEmailConfirmationCodeAsync(string toEmail, string toName, string confirmationLink);
        Task<bool> SendEmailChangeCodeAsync(string toEmail, string toName, string confirmationCode);
            ...
            /// <returns>Task representing the async operation. True if sent successfully, False otherwise.</returns>
            Task<bool> SendPasswordResetCodeAsync(string toEmail, string toName, string resetLink);
